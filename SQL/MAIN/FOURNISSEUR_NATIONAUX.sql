...
begin
	...
	loop
		dbms_output.put_line('Debut integration MGGRV des fournisseurs connus : '||curs.cdfo);	  
		...
		dbms_output.put_line('Fin integration MGGRV des fournisseurs connus : '||curs.cdfo); 
	end loop;
	commit;
